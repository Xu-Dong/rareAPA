...
MAFs = c('Coding','Conserved','Enhancer', 'Frame_shift', 'Intron', 'Promoter','Splice','Stop','TFBS','UTR_3','UTR_5','PAS50bp')
...
prp_r.1k.ipa <- counts2props(IN.DIR,MAFs,TYPEs,prefix = "RVcount_ipa_",suffix = ".txt")
...
prp_r.1k.ipa$Group <- "ipaOutlier"
#prp_r.1k.exp$Group <- "eOutlier"
#prp_r.1k.sp$Group <- "sOutlier"


# combined
dat.plot <- rbind(prp_r.1k.apa,prp_r.1k.ipa)


saveRDS(dat.plot,file="aOutlier_3UTR_vs_intron.RV_enriched_Anno.Z3.add_pvalue.v2.RDS")
#library(ggsci)
