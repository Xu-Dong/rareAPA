...
# Z2,10k:CADD_15
prp_r.1k.z2 <- counts2props(IN.DIR,MAFs,TYPEs,prefix = "apa_1k_Z2_",suffix = ".CADD_15.varCount.txt")
prp_r.1k.z3 <- counts2props(IN.DIR,MAFs,TYPEs,prefix = "apa_1k_Z3_",suffix = ".CADD_15.varCount.txt")
prp_r.1k.z4 <- counts2props(IN.DIR,MAFs,TYPEs,prefix = "apa_1k_Z4_",suffix = ".CADD_15.varCount.txt")
prp_r.1k.z5 <- counts2props(IN.DIR,MAFs,TYPEs,prefix = "apa_1k_Z5_",suffix = ".CADD_15.varCount.txt")

prp_r.1k.z2$Zcutoff <- "2"
prp_r.1k.z3$Zcutoff <- "3"
prp_r.1k.z4$Zcutoff <- "4"
prp_r.1k.z5$Zcutoff <- "5"


# combined
dat.plot <- rbind(prp_r.1k.z2,prp_r.1k.z3,prp_r.1k.z4,prp_r.1k.z5)

saveRDS(dat.plot,file="APA_IPA_RV_enrichment.CADD15.1k_Z2345.add_pvalue.RDS")
#library(ggsci)
