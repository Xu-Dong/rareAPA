...
read_file = function(dir, tissue,maf,cadd, prefix,suffix) {
  mafstr = paste0('_MAF',maf)
  caddstr = paste0('.',cadd)
  count = read.table(paste(dir,prefix,mafstr,caddstr,".",tissue,suffix,sep = ""),
...
# Z3,1k:CADD_0/15/25
prp_r.1k.coding.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,'Coding',prefix = "varCount_1k_Z4_SNP",suffix = ".txt")
prp_r.1k.conserved.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,'Conserved',prefix = "varCount_1k_Z4_SNP",suffix = ".txt")
prp_r.1k.splice.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,'Splice',prefix = "varCount_1k_Z4_SNP",suffix = ".txt")
prp_r.1k.utr3.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,'UTR_3',prefix = "varCount_1k_Z4_SNP",suffix = ".txt")
prp_r.1k.pas50.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,'PAS50bp',prefix = "varCount_1k_Z4_SNP",suffix = ".txt")

prp_r.1k.coding.maf0_1$CADD <- "Coding"
prp_r.1k.conserved.maf0_1$CADD <- "Conserved"
prp_r.1k.splice.maf0_1$CADD <- "Splice"
prp_r.1k.utr3.maf0_1$CADD <- "UTR_3"
prp_r.1k.pas50.maf0_1$CADD <- "PAS50bp"
...
# combined
dat.plot <- rbind(prp_r.1k.coding.maf0_1,prp_r.1k.conserved.maf0_1,prp_r.1k.splice.maf0_1,prp_r.1k.utr3.maf0_1,prp_r.1k.pas50.maf0_1)



saveRDS(dat.plot,file="singleTissue_aOutliers.SNV_enrichment.Z4.1k.MAF0_1.Categories.RDS")
