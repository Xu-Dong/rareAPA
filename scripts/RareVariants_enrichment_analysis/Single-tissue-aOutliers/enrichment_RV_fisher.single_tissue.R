...
IN.DIR = paste0(dir,'enrichment_snv_indel/')

# Z3,1k:CADD_0/15/25
prp_r.1k.cadd0.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,TYPEs,'0',prefix = "varCount_1k_Z3_",suffix = ".txt")
prp_r.1k.cadd15.maf0_1 <- counts2props(IN.DIR,tissue_list,MAF,TYPEs,'15',prefix = "varCount_1k_Z3_",suffix = ".txt")
...
dat.plot <- rbind(prp_r.1k.cadd0.maf0_1,prp_r.1k.cadd15.maf0_1)
#dim(prp_r.1k.cadd0.maf0_1)

saveRDS(dat.plot,file="singleTissue_aOutliers.SNV_and_indel_enrichment.Z3.1k.MAF0_1.RDS")
