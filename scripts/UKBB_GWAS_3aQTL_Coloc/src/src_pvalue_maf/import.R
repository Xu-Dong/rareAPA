...
#.libPaths(lp)
require(data.table)
library(hash,lib.loc="/lustre/home/wychen/anaconda3/envs/r4/lib/R/library/")
#require(hash,lib=lp)
...
#  link <- 'https://genome.ucsc.edu/goldenpath/help/hg19.chrom.sizes' #edit by CWY

  # Import table
#  table <- read.table(link, stringsAsFactors = FALSE) #edit by CWY

#table <- read.table("/lustre/home/xdzou/2023-01-19-reponse_aQTL_coloc/input/hg19.chrom.sizes",stringsAsFactors = FALSE)
table <- read.table("/lustre/home/hchen/2021-10-31-cancer-GWAS/00data/hg19.chrom.sizes", stringsAsFactors = FALSE) # edit by xdzou
