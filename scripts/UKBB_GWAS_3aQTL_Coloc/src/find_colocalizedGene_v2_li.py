...
# @xdzou: only use hypp4>0.75

import sys
import os

file_results="/lustre/home/lhgong/2023-04-21-UKB-coloc/output/coloc_dir"
file_GWASs="/lustre/home/lhgong/2023-04-21-UKB-coloc/input/gwas_dir"

file_results_tissue=os.listdir(file_results + "/134")
file_results_trait=os.listdir(file_results)

file_results_trait=sorted(file_results_trait)
#print(file_results_trait)
path_output=file_results+"/../summary_coloc/find_colocalizedGene_li.0.75.txt"
...
traitStart=1
traitFinished=len(file_results_trait) # @xdzou, 79 >> 78
        ...
        for tissueTrait in file_results_tissue:
                ...
                for line in f1:
                        ...
                        if line_split[5]!= "NA" and line_split[6]!="NA":
                                ...
                                #if hyp4 >0.75 and hyp4/(hyp3+hyp4)>=0.9:#@xdzou, change from 0.7 to 0.75
				if hyp4 >0.75:#@xdzou, change from 0.7 to 0.75
